...
program
  ...
  .option('--ai-provider <provider>', 'AI provider for failure analysis: ollama, docker, openai, anthropic, huggingface, bedrock, azureai')
...
program
  ...
  .option('--ai-provider <provider>', 'AI provider: local | ollama | docker | openai | anthropic | huggingface | bedrock | azureai')
